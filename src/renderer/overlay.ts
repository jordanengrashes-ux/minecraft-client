...
const PVP_GROUPS = [
  ...
  { label: '⌨️ HUD & Info', color: '#58a6ff', mods: [
    ...
    { slug: 'zoomify',               emoji: '🔍', name: 'Zoomify'               },
  ]},
  { label: '✨ Visual', color: '#a371f7', mods: [
    ...
    { slug: '3dskinlayers',          emoji: '🧍', name: '3D Skin Layers'        },
    { slug: 'blur',                  emoji: '🌫️', name: 'Blur'                  },
  ]},
  { label: '⚙️ Utility', color: '#3fb950', mods: [
    ...
    { slug: 'shulkerboxtooltip',     emoji: '📦', name: 'Shulker Tooltips'      },
    { slug: 'perspectivemod',        emoji: '📷', name: 'Perspective Mod'       },
  ]},
  { label: '⚡ Performance', color: '#f78166', mods: [
    { slug: 'sodium',                emoji: '⚡', name: 'Sodium'                },
    { slug: 'lithium',               emoji: '🔋', name: 'Lithium'               },
    { slug: 'iris',                  emoji: '🌈', name: 'Iris Shaders'          },
    { slug: 'entityculling',         emoji: '👁️', name: 'Entity Culling'        },
    { slug: 'memoryleakfix',         emoji: '🧹', name: 'Memory Leak Fix'       },
    { slug: 'ferrite-core',          emoji: '🔩', name: 'Ferrite Core'          },
  ]},
];
